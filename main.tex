...
\lstset{
    language=bash,
    basicstyle=\ttfamily\footnotesize, % Fuente para el código
    ...
    backgroundcolor=\color{lightgray!20}, % Fondo gris claro
}
...
% report variant calling : bcftools stats $vcf > report_variant_calling.txt
